...
class Match(models.Model):
	...
	is_custom_match = fields.BooleanField(default=False, null=True)
...
class Cache(models.Model):
	...
	def actual_content(self) -> dict:
		return pickle.loads(base64.b64decode(self.content.encode()))
...
class Season(models.Model):
	...
	is_off_season = fields.BooleanField(default=False)
	api_url = fields.CharField(max_length=255)
